...
flags.DEFINE_integer('num_centroids', 0, 'Number of centroids used in VampPrior')
...
flags.DEFINE_integer('trained_epochs', 0, 'Number of epochs that have been trained')
...
flags.DEFINE_float('delta', 11.0, 'Weight of ATC local ranking loss')
flags.DEFINE_integer('nneg', 11, 'Number of negative examples sampled when calculating local ranking loss')
